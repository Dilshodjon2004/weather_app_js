const timeEl = document.querySelector("#time"),
  ...
  currentweatherItemsEl = document.querySelector("#current-weather-items"),
  timezone = document.querySelector("#time-zone"),
  countryEl = document.querySelector("#country"),
  weatherForecastEl = document.querySelector("#weather-forecast"),
    ...
    if (idx == 0) {
      ...
      <div class="weather-forecast-item">
        ...
        <img
          ...
          class="w-icon"
        />
        <div class="temp">Day - ${day.temp.eve.toFixed(0)}&#176; C</div>
        <div class="temp">Night - ${day.temp.night.toFixed(0)}&#176; C</div>
      </div>
      `;
    }
